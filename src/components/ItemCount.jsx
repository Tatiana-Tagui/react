  ...
  return (
    <div>
      <div className="botonesMasMenosCantidad">
        <button className="btn btn-dark botonMenos" onClick={() => restar()}>
          -
        </button>
        {cantidad}
        <button className="btn btn-dark botonMas" onClick={() => sumar()}>
          +
        </button>
      </div>
      <button className="btn btn-primary" onClick={addItemCart}>
        Agregar Carrito
      </button>
    </div>
  );
